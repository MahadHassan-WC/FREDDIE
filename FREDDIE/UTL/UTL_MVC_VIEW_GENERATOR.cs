...
using System.Data;
  ...
  public   class UTL_MVC_VIEW_GENERATOR
    {
    ...
    private string _INDEX_CSHTML;
    public System.String INDEX_CSHTML
    {
        get { return _INDEX_CSHTML; }

    }
    public void GENERATE_ALL_VIEWS(string SERVER_NAME, string DATABASE_NAME, string OBJECT_NAME , int OBJECT_ID)
        {
        List<FREDS_MATRIX> ATTRIBUTES = UTL_GET_ATTRIBUTES_TABLE(SERVER_NAME, DATABASE_NAME.ToUpper(), OBJECT_ID, false);
        GENERATE_INDEX_VIEW(ATTRIBUTES, OBJECT_NAME);
        }
        private void  GENERATE_INDEX_VIEW(List<FREDS_MATRIX> COLUMNS_TO_SELECT, String OBJECT_NAME)
        {
        string ModelName = UTL_GENERATE_MODEL_CLASS_NAME(OBJECT_NAME);
        _INDEX_CSHTML = "@using MYNAMESPACE;" + Environment.NewLine +
        "@{" + Environment.NewLine +
        "IEnumerable<" + ModelName + "> lst = ViewData[" + Q + "dbdata" + Q + "] as IEnumerable<" + ModelName + ">;" + Environment.NewLine +
        "}" + Environment.NewLine +
        "<!DOCTYPE html>" + Environment.NewLine +
        "<html>" + Environment.NewLine +
        "<head>" + Environment.NewLine +
        "<meta name=" + Q + "viewport" + Q + "content=" + Q + "width = device - width" + Q + "/> " + Environment.NewLine +
        "<title>Index</title>" + Environment.NewLine +
        "</head>" + Environment.NewLine +
        "<body>" + Environment.NewLine +
        "<p>" + Environment.NewLine +
        "<a asp-action=" + Q + "Create" + Q + ">Create New</a> " + Environment.NewLine +
        "</p>" + Environment.NewLine +
        "<table class=" + Q + "table" + Q + "> " + Environment.NewLine +
        "<thead>" + Environment.NewLine +
        "<tr> " + Environment.NewLine;

        foreach(FREDS_MATRIX f in COLUMNS_TO_SELECT)
        {
            _INDEX_CSHTML += "<th>" + f.COLUMN_NAME + "</th>" + Environment.NewLine;
        }

        _INDEX_CSHTML += " " + Environment.NewLine +
        " " + Environment.NewLine +
        " </tr>" + Environment.NewLine +
        "</thead> " + Environment.NewLine +
           " <tbody> " + Environment.NewLine +

             "@foreach (" + ModelName + " item in lst) " + Environment.NewLine +
        ...
        foreach (FREDS_MATRIX f in COLUMNS_TO_SELECT)
        {
            _INDEX_CSHTML += "<td>" + "@Html.DisplayFor(modelItem => item." +  f.COLUMN_NAME + ")</td>" + Environment.NewLine;
        }
        _INDEX_CSHTML += " </tr> " + Environment.NewLine +
      " }" + Environment.NewLine +
        ...
        private string GENERATE_CREATE_VIEW(List<FREDS_MATRIX> COLUMNS_TO_SELECT, String OBJECT_NAME)
        {
            return "";
        }
        private string GENERATE_EDIT_VIEW(List<FREDS_MATRIX> COLUMNS_TO_SELECT, String OBJECT_NAME)
        {
            return "";
        }
        private string GENERATE_DELETE_VIEW(List<FREDS_MATRIX> COLUMNS_TO_SELECT, String OBJECT_NAME)
        {
            return "";
        }
