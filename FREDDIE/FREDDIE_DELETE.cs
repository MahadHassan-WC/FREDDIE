...
using SqlSvrMeta;
  ...
  public  class FREDDIE_DELETE
    {

    private bool _DELETE_A_ROW;
    private bool _DELETE_ALL_ROWS;
    private bool _DELETE_CUSTOM;
    ...
    public bool DELETE_A_ROW
    {
        get
        {
            return _DELETE_A_ROW;
        }
        set
        {
            _DELETE_A_ROW = value;
    ...
    public bool DELETE_ALL_ROWS
    {
        get
        {
            return _DELETE_ALL_ROWS;
        }
        set
        {
            _DELETE_ALL_ROWS = value;
        }
    }
    public bool DELETE_CUSTOM
    {
        get
        {
            return _DELETE_CUSTOM;
        }
        set
        {
            _DELETE_CUSTOM = value;
        }
    }
    private string GENERATE_SQL_CONSTRUCTOR(List<CS_SQLSERVER_COLUMN_MATRIX> lst)
    {
        return "DATABASE_CLASS_NAME = this.GetType().Name;" + Environment.NewLine +
                         ...
                         "DATABASE_DML_TYPE = " + Q + "DELETE" + Q + ";" + Environment.NewLine +
                         "DATABASE_NAME = DEFAULT_DB;" + Environment.NewLine +
                         "DATABASE_OBJECT_TYPE = " + Q + "TABLE" + Q + ";" + Environment.NewLine;
    }


    private string SQL_DELETE_A_ROW(List<CS_SQLSERVER_COLUMN_MATRIX> lst)
    {
        string SQL = "const string SQL_DELETE_A_ROW = @" + Q + "DELETE FROM dbo." + lst[0].CS_DB_OBJECT_NAME   + " WHERE " + Environment.NewLine;
    ...
    private string SQL_DELETE_ALL_ROWS(List<CS_SQLSERVER_COLUMN_MATRIX> lst)
    {
        string SQL = "const string SQL_DELETE_ALL_ROWS = @" + Q + "DELETE FROM dbo." + lst[0].CS_DB_OBJECT_NAME + Environment.NewLine  ;
        return SQL + T3 + Q + ";" + Environment.NewLine + Environment.NewLine + Environment.NewLine;
    }
    public string GENERATE_DELETE_A_ROW(List<CS_SQLSERVER_COLUMN_MATRIX> lst)
    {
        ...
        try
        {
            ...
            return SQL_DELETE_A_ROW(lst) +
                "public Boolean DEL(" + lst[0].CS_OBJECT_NAME + " O)" + Environment.NewLine +
                   "{" + Environment.NewLine +
                  "try{" + Environment.NewLine +
                           "DATABASE_METHOD_NAME  = System.Reflection.MethodBase.GetCurrentMethod().Name;" + Environment.NewLine +
                           "DATABASE_CMD_SQL = SQL_DELETE_A_ROW;  " + Environment.NewLine +
                           "DATABASE_DML_TYPE = " + Q + "DELETE" + Q + ";" + Environment.NewLine +
    ...
    public string GENERATE_DELETE_ALL_ROWS(List<CS_SQLSERVER_COLUMN_MATRIX> lst)
    {
        ...
        try
        {
            ...
            return SQL_DELETE_ALL_ROWS(lst) +
                "public Boolean DEL_ALL_ROWS()" + Environment.NewLine +
                   "{" + Environment.NewLine +
                  "try{" + Environment.NewLine +
                           "DATABASE_METHOD_NAME  = System.Reflection.MethodBase.GetCurrentMethod().Name;" + Environment.NewLine +
                           "DATABASE_CMD_SQL = SQL_DELETE_ALL_ROWS;  " + Environment.NewLine +
                           "DATABASE_DML_TYPE = " + Q + "DELETE" + Q + ";" + Environment.NewLine +
                           "DATABASE_MESSAGE_LEVEL = 0;  " + Environment.NewLine +
    ...
    public string GENERATE_DELETE_METHODS(string SERVER_NAME, string DATABASE_NAME, string TABLE_NAME, int OBJECT_ID)
    {
        ...
        if (DELETE_A_ROW)
        {
            MySTRING += GENERATE_DELETE_A_ROW(lst);
        }
        if(DELETE_ALL_ROWS)
        {
            MySTRING += GENERATE_DELETE_ALL_ROWS(lst);
        }
